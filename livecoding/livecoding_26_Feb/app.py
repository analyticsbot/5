...
##    def runTheProgram():
##        dd = {'livecoding_like_cnt': 0}
##        main(dd['keywords'], dd['profile'], dd['liveCodingLikeMin'], dd['liveCodingLikeMax'],dd['programmingLanguagesMinLike'],\
##                     dd['programmingLanguagesMinRT'], dd['programmingLikeMax'], dd['programmingRTMax'], dd['accountFollowedMinLike'], dd['accountFollowedMinRT'],\
##                     dd['accountFollowedLikeMin'], dd['accountFollowedLikeMax'], dd['accountFollowedRTMin'],\
##                     dd['accountFollowedRTMax'], dd['replyTweet'])
##            
##    sched.start()
