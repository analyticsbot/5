...
def programmingLanguages(arguments):
    pass
...
def suggestLivecoding(arguments):
    pass
...
def main(keywords, profile, liveCodingLikeMin, liveCodingLikeMax,prgrammingLanguagesMinLike,\
                 prgrammingLanguagesMinRT, accountFollowedMinLike, accountFollowedMinRT,\
                 accountFollowedLikeMin, accountFollowedLikeMax, accountFollowedRTMin,\
                 accountFollowedRTMax, replyTweet):
    arguments = [keywords, profile, liveCodingLikeMin, liveCodingLikeMax,prgrammingLanguagesMinLike,\
                 prgrammingLanguagesMinRT, accountFollowedMinLike, accountFollowedMinRT,\
                 accountFollowedLikeMin, accountFollowedLikeMax, accountFollowedRTMin,\
                 accountFollowedRTMax, replyTweet]
    threads= []
    #Check for tweets with livecoding.tv/ and like 1 out of every 4 tweets. 
    threads.append(Thread(target = workonTwitter, args=('livecoding.tv', arguments)))
    ...
    threads.append(Thread(target = workonTwitter, args=('programming languages', arguments)))
    ...
    threads.append(Thread(target = workonTwitter, args=('suggest Livecoding.tv', arguments)))

    #Most popular tweets (Min 20 likes/ 10 RTS) from accounts we follow.
    #For every 10 tweets Retweet. For every 4 tweets, Like 1.
    threads.append(Thread(target = workonTwitter, args=('accounts we follow', arguments)))
...
def loadProfile():
    c.execute("select profile_name, keywords, default from keywords")
    data = c.fetchall()
    return render_template('profiles.html', data = data)
    
@app.route('/makedefault/<profile>', methods=['GET', 'POST'])
def makeDefault(profile):
    c.execute("UPDATE keywords SET default=0")
    conn.commit()
    c.execute("UPDATE keywords SET default=1 where profile_name = " + str(profile))
    conn.commit()
    
    
def getParams():
    c.execute("SELECT liveCodingLikeMin, liveCodingLikeMax,prgrammingLanguagesMinLike,\
                 prgrammingLanguagesMinRT, accountFollowedMinLike, accountFollowedMinRT,\
                 accountFollowedLikeMin, accountFollowedLikeMax, accountFollowedRTMin,\
...
def updateVariables(liveCodingLikeMin, liveCodingLikeMax,prgrammingLanguagesMinLike,\
                 prgrammingLanguagesMinRT, accountFollowedMinLike, accountFollowedMinRT,\
                 accountFollowedLikeMin, accountFollowedLikeMax, accountFollowedRTMin,\
                 accountFollowedRTMax, replyTweet):
    c.execute("UPDATE variables SET liveCodingLikeMin= " + str(liveCodingLikeMin) + \
              " liveCodingLikeMax = " + str(liveCodingLikeMin) +  \
              " prgrammingLanguagesMinLike = " + str(prgrammingLanguagesMinLike) + " prgrammingLanguagesMinRT = " + str(prgrammingLanguagesMinRT) +\
...
def home():
    ...
    params = getParams()
    liveCodingLikeMin, liveCodingLikeMax,prgrammingLanguagesMinLike,\
                 prgrammingLanguagesMinRT, accountFollowedMinLike, accountFollowedMinRT,\
                 accountFollowedLikeMin, accountFollowedLikeMax, accountFollowedRTMin,\
    ...
    return render_template('index.html', keywords = keywords, defaultProfile = 'Profile',\
                           ...
                           prgrammingLanguagesMinLike = prgrammingLanguagesMinLike,
                 prgrammingLanguagesMinRT=prgrammingLanguagesMinRT, accountFollowedMinLike=accountFollowedMinLike,\
...
def go():
    ...
    if request.method == "POST":
        ...
        prgrammingLanguagesMinLike = request.form['prgrammingLanguagesMinLike']
        prgrammingLanguagesMinRT = request.form['prgrammingLanguagesMinRT']
        ...
        print keywords, profile, liveCodingLikeMin, liveCodingLikeMax,prgrammingLanguagesMinLike,\
                 prgrammingLanguagesMinRT, accountFollowedMinLike, accountFollowedMinRT,\
                 accountFollowedLikeMin, accountFollowedLikeMax, accountFollowedRTMin,\
                 accountFollowedRTMax, replyTweet
        ...
        session['prgrammingLanguagesMinLike'] = prgrammingLanguagesMinLike
        session['prgrammingLanguagesMinRT'] = prgrammingLanguagesMinRT
        ...
        if (keywords != ''):
            gc.collect()
            ## call the threads
            updateVariables(liveCodingLikeMin, liveCodingLikeMax,prgrammingLanguagesMinLike,\
                 prgrammingLanguagesMinRT, accountFollowedMinLike, accountFollowedMinRT,\
                 accountFollowedLikeMin, accountFollowedLikeMax, accountFollowedRTMin,\
                 accountFollowedRTMax, replyTweet)
            ...
            main(keywords, profile, liveCodingLikeMin, liveCodingLikeMax,prgrammingLanguagesMinLike,\
                 prgrammingLanguagesMinRT, accountFollowedMinLike, accountFollowedMinRT,\
                 accountFollowedLikeMin, accountFollowedLikeMax, accountFollowedRTMin,\
                 accountFollowedRTMax, replyTweet)
